...
export const QUERY_KEYS = {
  ...
  dashboardsInfinite: (size: number) =>
    ['dashboards', 'infinite', size] as const,
  ...
  columnCards: (dashboardId: number) =>
    ['columns', dashboardId, 'cards'] as const,
  ...
  invitationsBase: (dashboardId: number) =>
    ['invitations', dashboardId] as const,
