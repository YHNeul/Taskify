    ...
    <>
      {members.map((member, index) => (
        ...
        >
          ...
          <span className="pointer-events-none absolute left-1/2 top-full z-20 mt-1 -translate-x-1/2 whitespace-nowrap rounded-xl bg-gray-600 px-2 py-1 typo-xs-medium text-white opacity-0 transition-opacity group-hover:opacity-100">
            {member.nickname}
          </span>
        </div>
      ))}
